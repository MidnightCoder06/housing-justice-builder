...
import { Upload, FileText, CheckCircle, AlertTriangle, Loader2, PenTool, Plus, Minus } from 'lucide-react'
        ...
        <div className="mb-8">
          <div className="flex justify-center">
            <div className="flex gap-3">
              ...
              <a href="/camelbackventures-product-demo/generate" className="flex items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors">
